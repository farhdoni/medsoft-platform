...
const Plus3D = ({ size }: { size: Size }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" style={{ overflow: "visible" }}>
    <defs>
      {grad("pl-body", PALETTE.purple.light, PALETTE.purple.mid, PALETTE.purple.dark)}
      {radial("pl-hl", "#fff", "#fff")}
    </defs>
    <ellipse cx="32" cy="58" rx="13" ry="2" fill="rgba(80, 70, 140, 0.2)" />
    <circle cx="32" cy="32" r="22" fill="url(#pl-body)" stroke={PALETTE.purple.dark} strokeWidth="0.8" />
    <rect x="29" y="20" width="6" height="24" rx="1.5" fill="#fff" />
    <rect x="20" y="29" width="24" height="6" rx="1.5" fill="#fff" />
    <ellipse cx="22" cy="22" rx="3.5" ry="6" fill="url(#pl-hl)" opacity="0.6" />
  </svg>
);

const Home3D = ({ size }: { size: Size }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" style={{ overflow: "visible" }}>
    <defs>
      {grad("hm-body", PALETTE.mint.light, PALETTE.mint.mid, PALETTE.mint.dark)}
      {radial("hm-hl", "#fff", "#fff")}
    </defs>
    <ellipse cx="32" cy="58" rx="14" ry="2" fill="rgba(80, 70, 140, 0.2)" />
    <path d="M10 30 L32 12 L54 30 L54 52 Q54 56 50 56 L14 56 Q10 56 10 52 Z"
      fill="url(#hm-body)" stroke={PALETTE.mint.dark} strokeWidth="0.8" strokeLinejoin="round" />
    <rect x="26" y="38" width="12" height="18" rx="1" fill={PALETTE.mint.dark} opacity="0.5" />
    <ellipse cx="20" cy="28" rx="3" ry="5" fill="url(#hm-hl)" opacity="0.7" />
  </svg>
);

const Settings3D = ({ size }: { size: Size }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" style={{ overflow: "visible" }}>
    <defs>
      {grad("sg-body", PALETTE.blue.light, PALETTE.blue.mid, PALETTE.blue.dark)}
    </defs>
    <ellipse cx="32" cy="58" rx="14" ry="2" fill="rgba(80, 70, 140, 0.2)" />
    <path d="M32 8 L36 14 L43 12 L44 19 L51 22 L48 28 L52 34 L46 38 L46 45 L39 45 L34 51 L28 47 L21 50 L19 43 L13 39 L17 33 L13 27 L19 23 L20 16 L27 17 Z"
      fill="url(#sg-body)" stroke={PALETTE.blue.dark} strokeWidth="0.8" strokeLinejoin="round" />
    <circle cx="32" cy="32" r="8" fill="#fff" stroke={PALETTE.blue.dark} strokeWidth="0.8" />
  </svg>
);

const Doctor3D = ({ size }: { size: Size }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" style={{ overflow: "visible" }}>
    <defs>
      {grad("dc-coat", PALETTE.white.light, PALETTE.white.mid, PALETTE.white.dark)}
      {grad("dc-board", PALETTE.blue.light, PALETTE.blue.mid, PALETTE.blue.dark)}
      {grad("dc-pants", PALETTE.blue.mid, PALETTE.blue.dark, "#3d4d75")}
      {grad("dc-skin", "#fde0c8", "#f5c8a0", "#d8a070")}
      {grad("dc-hair", "#5a4030", "#3a2820", "#1f1410")}
    </defs>
    <ellipse cx="32" cy="60" rx="18" ry="2.2" fill="rgba(80, 70, 140, 0.22)" />
    <rect x="6" y="14" width="28" height="36" rx="3" fill="url(#dc-board)" stroke={PALETTE.blue.dark} strokeWidth="0.8" />
    ...
    <rect x="33" y="44" width="4.5" height="14" rx="1.8" fill="url(#dc-pants)" />
    <rect x="40.5" y="44" width="4.5" height="14" rx="1.8" fill="url(#dc-pants)" />
    <ellipse cx="35.2" cy="59" rx="3.2" ry="1.4" fill="#3a2820" />
    <ellipse cx="42.8" cy="59" rx="3.2" ry="1.4" fill="#3a2820" />
    <path d="M30 26 Q30 22.5 34 22.5 L46 22.5 Q50 22.5 50 26 L51 46 Q40 49 29 46 Z"
      fill="url(#dc-coat)" stroke={PALETTE.white.dark} strokeWidth="0.6" strokeLinejoin="round" />
    <path d="M39 24 L41 24 L42 32 L40 36 L38 32 Z" fill={PALETTE.blue.dark} />
    ...
    <circle cx="40" cy="14" r="6.2" fill="url(#dc-skin)" stroke="#c89070" strokeWidth="0.4" />
    <path d="M34 12 Q35 6.5 40 6.5 Q46 6.5 46.2 12.8 Q46 10 43 9 Q39.5 8.2 36.5 11 Z" fill="url(#dc-hair)" />
    <ellipse cx="37.5" cy="14.5" rx="0.9" ry="1.3" fill="#1a1a2e" />
    <ellipse cx="42" cy="14.5" rx="0.9" ry="1.3" fill="#1a1a2e" />
    <circle cx="37.7" cy="14.1" r="0.3" fill="#fff" />
    <circle cx="42.2" cy="14.1" r="0.3" fill="#fff" />
    <path d="M38.5 18 Q40 19 41.5 18" fill="none" stroke="#a85040" strokeWidth="0.6" strokeLinecap="round" />
  </svg>
);

const Pill3D = ({ size }: { size: Size }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" style={{ overflow: "visible" }}>
    <defs>
      {grad("pi-l", PALETTE.pink.light, PALETTE.pink.mid, PALETTE.pink.dark)}
      {grad("pi-r", PALETTE.white.light, PALETTE.white.mid, PALETTE.white.dark)}
    </defs>
    <ellipse cx="32" cy="58" rx="13" ry="2" fill="rgba(80, 70, 140, 0.2)" />
    <g transform="rotate(-30 32 32)">
      <rect x="8" y="24" width="24" height="16" rx="8" fill="url(#pi-l)" stroke={PALETTE.pink.dark} strokeWidth="0.8" />
      <rect x="32" y="24" width="24" height="16" rx="8" fill="url(#pi-r)" stroke={PALETTE.white.dark} strokeWidth="0.8" />
      <ellipse cx="14" cy="28" rx="2.5" ry="1.5" fill="#fff" opacity="0.6" />
    </g>
  </svg>
);
