...
const HOW_IT_WORKS = [
  ...
  { icon: '💰', title: 'Получаете оплату', desc: 'Выплаты еженедельно', bg: '#fdf4e0', color: '#8a6020' },
];
...
const FAQ_ITEMS = [
  ...
  { q: 'Когда приходят деньги?', a: 'Выплаты проводятся еженедельно. Минимальная сумма для вывода — 50 000 сум. Деньги приходят на вашу карту UzCard или HUMO.' },
        ...
        <div className="px-4 pt-5">
          ...
          <div className="rounded-2xl bg-white border border-[#e8e4dc] divide-y divide-[#f4f3ef]">
            {[
              ...
              { num: '3', title: 'Привяжите карту', desc: 'Для еженедельных выплат' },
            ].map(step => (
