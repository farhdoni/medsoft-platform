...
// Flow A — the existing 6-step wizard, moved here unchanged so the top-level
// page.tsx can be a thin server component that decides, per account, whether
// to render this (unflagged — zero behavior change) or the new Consent/Q1/
// R1/Q2/Done1 ladder (flagged accounts only). See page.tsx for the gate.
