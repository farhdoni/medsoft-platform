...
import { aivitaAdminUsersRouter } from './routes/aivita-admin-users.js';
import { aivitaAdminDoctorsRouter } from './routes/aivita-admin-doctors.js';
import { aivitaAdminBillingRouter } from './routes/aivita-admin-billing.js';
import { aivitaAdminHomeSettingsRouter } from './routes/aivita-admin-home-settings.js';
import { aivitaAdminSupportRouter } from './routes/aivita-admin-support.js';
import { aivitaAdminAnalyticsRouter } from './routes/aivita-admin-analytics.js';
...
import { surveyRouter } from './routes/aivita/survey.js';
...
import { aivitaTelegramRouter } from './routes/aivita/telegram.js';
...
import { aivitaHomeStateRouter } from './routes/aivita/home-state.js';
...
import { downloadStatsRouter } from './routes/download-stats.js';
...
app.route('/v1/aivita/home-state', aivitaHomeStateRouter);
...
app.route('/v1/aivita-admin', aivitaAdminBillingRouter);
app.route('/v1/aivita-admin', aivitaAdminHomeSettingsRouter);
app.route('/v1/aivita-admin/analytics', aivitaAdminAnalyticsRouter);
app.route('/v1/aivita/users', aivitaUsersRouter);
app.route('/v1/aivita/health-profile', aivitaHealthProfileRouter);
app.route('/v1/aivita/survey', surveyRouter);
...
app.route('/v1/aivita/telegram', aivitaTelegramRouter);
...
app.route('/v1/aivita/drugs', aivitaDrugsRouter);
