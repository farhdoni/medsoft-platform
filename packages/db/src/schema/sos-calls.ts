import { decimal, integer, jsonb, pgEnum, pgTable, text, timestamp, uuid } from 'drizzle-orm/pg-core';
...
export const sosCalls = pgTable('sos_calls', {
  ...
  brigadDispatchedAt: timestamp('brigad_dispatched_at', { withTimezone: true }),
  brigadArrivedAt: timestamp('brigad_arrived_at', { withTimezone: true }),
