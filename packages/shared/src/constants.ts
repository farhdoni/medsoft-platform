...
export const AI_INTENTS = ['symptom_check', 'doctor_recommendation', 'medication_info', 'lifestyle_advice', 'other'] as const;
export type AiIntent = (typeof AI_INTENTS)[number];

export const AI_OUTCOMES = ['appointment_booked', 'self_care_advised', 'sos_triggered', 'no_action', 'abandoned'] as const;
